...
<div class="table_header">
  <h1>{{ site.data.T36.tournament.week_post_title }}</h1>
  <h2>{{ site.data.T36.tournament.week_post_subtitle }}</h2>
</div>

{% for i in (1..page.loop_count) %}
<span class="table_nextupdate">as at {{ site.data.T36.update_at }}, next update {{ site.data.T36.update_weekly_timestamp }} UTC</span> 
