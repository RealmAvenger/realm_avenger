...
<div class="table_header">
    <h1><a href="{{ site.data.T36-d4.tournament.week_results_table_url }}">Tournament {{ site.data.T36-d4.tournament.tournament_week }}</a>, Day {{ site.data.T36-d4.tournament.tournament_day }}</h1>
    <h2>{{ site.data.T36-d4.tournament.day_post_subtitle }}</h2>  
</div>
